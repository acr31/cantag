...
public:
   ...
   * or NULL if none do.
   */
  inline SceneGraphNode<S,PAYLOAD_SIZE>* Find(const CyclicBitSet<PAYLOAD_SIZE>& code ) const;
};
...
template<class S,int PAYLOAD_SIZE> SceneGraphNode<S,PAYLOAD_SIZE>* SceneGraph<S,PAYLOAD_SIZE>::Find(const CyclicBitSet<PAYLOAD_SIZE>& code) const {
