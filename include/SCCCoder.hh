...
public:
  ...
  virtual int GetSymbolSize() const { return RINGS; }
  virtual int GetHammingDistanceBits() const { return 2*ERRORS+1; }
  virtual int GetHammingDistanceSymbols() const { return 2*ERRORS+1; }
