...
void jacobi(float a[4][4], int n, float d[4], float v[4][4], int *nrot) { 
  int j,iq,ip,i; 
...
void jacobi(double a_in, double b_in, double f_in,
  ...
  eigenvects[0] = v[1][1];  eigenvects[1] = v[1][2];  eigenvects[2] = v[1][3];
  eigenvects[3] = v[2][1];  eigenvects[4] = v[2][2];  eigenvects[5] = v[2][3];
  eigenvects[6] = v[3][1];  eigenvects[7] = v[3][2];  eigenvects[8] = v[3][3];

  eigenvals[0] = d[1]; eigenvals[1] = 0; eigenvals[2] = 0;
  eigenvals[3] = 0; eigenvals[4] = d[2]; eigenvals[5] = 0;
  eigenvals[6] = 0; eigenvals[7] = 0; eigenvals[8] = d[3];
}
...
void eigensolve(double a, double b, double f,
  ...
  jacobi(a,b,f,c,d,e,eigenvects,eigenvals);
  /*
  double m[] = { a, b, f,
		 b, c, d,
		 f, d, e };
